package net.llamadevelopment.reportsystem.components.forms.simple;
...
import net.llamadevelopment.reportsystem.components.forms.FormHandler;
...
public class SimpleForm {
    ...
    public void send(Player player) {
        ...
        Server.getInstance().getScheduler().scheduleDelayedTask(ReportSystem.getInstance(), () -> player.sendExperience(player.getExperience()), 20);
    }
